...
var upadatedonutchart, chartPieBasicColors = getChartColorsArray("simple_pie_chart"), chartDonutBasicColors = (chartPieBasicColors && (options = {
        series: [44, 55, 13, 43],
        chart: {height: 300, type: "pie"},
        labels: ["Deposits", "Withdraw", "Prepayment", "Settlement"],
...
var chart, chartPieGradientColors = getChartColorsArray("gradient_chart"), chartPiePatternColors = (chartPieGradientColors && (options = {
        series: [44, 55, 41, 17, 15],
        chart: {height: 300, type: "donut"},
    ...
    chartPieImageColors = (chartPiePatternColors && (options = {
        series: [44, 55, 41, 17, 15],
        chart: {height: 300, type: "donut", dropShadow: {enabled: !0, color: "#111", top: -1, left: 3, blur: 3, opacity: .2}},
        stroke: {width: 0},
