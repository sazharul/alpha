...
const apiClient = axios.create({
    baseURL: import.meta.env.VITE_API_BASE_URL || 'https://optixpay.britishmarketplace.co.uk', // Replace with your API URL or use env variables
            ...
            if (refreshToken) {
                try {
                    ...
                    const response = await axios.post(
                        `${import.meta.env.VITE_API_BASE_URL || 'https://optixpay.britishmarketplace.co.uk'}/login/refresh/`,
